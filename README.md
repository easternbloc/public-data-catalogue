...
This is a specification for the *public-data-catalogue* API.
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `public-data-catalogue-target`.
